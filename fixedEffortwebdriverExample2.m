...
tspan=0:dt:150;
    ...
    %B0=SimCons(k).free.B;
    B0=[0.001820357,0,0.038438396,0.038305154,0.155727354,0.075672302,1.206425507,0.001303005,0.000356831,0.05035398,0.264208829,0.207503338,0.083799658,0.082391443,0.002549374,0.05456997,0.079095309,0.112195001,0.001833739,4.84637251990166e-06,0.012931887,0.010512798,0.092388966,0.005138328,0,0.046388367,0.0377947,0,0.024755901,0.070278471];
...
for i = 2:n_steps
    ...
    [~, Xtemp] = ode45(@(t,X) differential2(t,X,params),[t(i-1), t(i)], X(i-1,:)', options);
...
for i = 1:nSteps
    ...
    J_series(:,:,i) = computeJacobian(@differential2, xi, ti, params);
end
%% PLOT RESULTS
%figure
%set(gcf,'color','w');
